...
**ClearDrops**, yerde biriken sahipsiz eşyaları düzenli aralıklarla silerek sunucu performansını koruyan (lag önleyici) bir Minecraft eklentisidir. Oyuncuları temizlik işleminden önce uyararak önemli eşyalarını almalarına fırsat tanır.

### 🛠️ Kullanım
- `/cleardrops` (veya `/temizle`): Yerde duran tüm sahipsiz eşyaları anında siler.
